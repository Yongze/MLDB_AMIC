...
class MyDataset_BASEx(data.Dataset):  #
    def __init__(self, train=True, target_list=None):
        self.train = train
        ...
        if target_list is None:
            ...
            target_list[0] += "_test.csv"

        # load source domain dataset images folders
        if self.train:
            self.img_list, self.label_list = self.convert_labeled_list(source_list, r=1)
        else:
